...
export default function Sidebar({ userRole = "ADMIN", activeSection, onSectionChange, collapsed, onToggleCollapse }) {
      ...
      <div className="p-4 border-b border-sidebar-border flex items-center justify-between">
        {!collapsed && (
          <div className="flex items-center space-x-2">
            <h2 className="text-xl font-bold text-sidebar-foreground">ECommerce</h2>
            {!isValidRole && <AlertTriangle className="h-4 w-4 text-destructive" title="Rol no válido" />}
          </div>
        )}
        <Button
          variant="ghost"
          ...
          <div className="flex items-center justify-between">
            <Badge
              ...
              className={cn(
                ...
                userRole === "USUARIO" && "bg-secondary text-secondary-foreground",
              )}
            >
              ...
              <li key={item.key}>
                <Button
                  ...
                  className={cn(
                    ...
                    isActive && "bg-sidebar-primary text-sidebar-primary-foreground hover:bg-sidebar-primary shadow-sm",
      ...
      {!collapsed && (
        <div className="p-4 border-t border-sidebar-border">
          <div className="text-center space-y-2">
            <p className="text-xs text-muted-foreground">© 2024 ECommerce Dashboard</p>
