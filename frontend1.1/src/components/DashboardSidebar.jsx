...
const menuItems = {
  ADMIN: [
    ...
    },
    {
      ...
      label: "Tienda",
      key: "store",
      description: "Vista de la tienda",
    },
...
export default function DashboardSidebar({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="p-4 border-b border-green-200 dark:border-green-700 flex items-center justify-between bg-white/50 dark:bg-gray-800/90">
        {!collapsed && (
