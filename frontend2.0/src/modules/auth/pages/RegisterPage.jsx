...
const RegisterPage = () => {
  ...
  return (
    <>
      <Navbar />
      {/* Ajuste de clases en el contenedor principal.
        Eliminamos el div de espaciado y agregamos un padding superior (pt-40).
        Este valor asegura que haya suficiente espacio para el navbar fijo, 
        independientemente de su altura.
      */}
      <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-40 pb-10 px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-lg w-full max-w-md text-center">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <SubmitButton text="Registrarse" isLoading={isSubmitting} />
          </form>
