...
import Footer from "../../layout/Footer"; // Importa el componente Footer
...
const LoginPage = () => {
  ...
  return (
    <>
      {" "}
      {/* Agrega un fragmento de React para envolver ambos componentes */}
      ...
      <AuthLayout title="Iniciar Sesión">
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <SubmitButton text="Ingresar" isLoading={isSubmitting} />
        </form>
