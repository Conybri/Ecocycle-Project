      ...
      >
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative hidden md:block group">
            ...
            <div
              className={`relative rounded-2xl border shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm ${
                isDarkMode
        ...
        <div className="flex items-center space-x-6 lg:space-x-8">
          ...
          {/* EcoPoints - Con separador visual */}
          <div className="flex items-center">
            {/* Separador sutil */}
            <div
              className={`hidden lg:block w-px h-8 mx-2 ${
                isDarkMode ? "bg-gray-600/30" : "bg-gray-300/50"
              }`}
            ></div>

            <div
              className={`hidden md:flex items-center space-x-2 px-5 py-2.5 rounded-lg border ${
                isDarkMode
          ...
          {/* Notifications - Con más espaciado */}
          <div className="flex items-center">
            {/* Separador sutil */}
            <div
              className={`hidden lg:block w-px h-8 mx-2 ${
            ...
            <div className="relative">
              <button
                ...
                className={`p-3.5 rounded-2xl border shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 relative group backdrop-blur-sm ${
                  isDarkMode
                    ? "bg-gray-800/80 border-gray-600/50"
                    : "bg-white/80 border-green-200/50"
                }`}
              ...
              {showNotifications && (
                <div
                  className={`absolute right-0 mt-4 w-80 border rounded-2xl shadow-2xl z-50 backdrop-blur-xl ${
                    isDarkMode
          ...
          {/* User menu - Con más espaciado y separador */}
          <div className="flex items-center">
            {/* Separador sutil */}
            <div
              className={`hidden lg:block w-px h-8 mx-2 ${
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center space-x-3 p-2.5 rounded-2xl border shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group backdrop-blur-sm ${
                  isDarkMode
                    ? "bg-gray-800/80 border-gray-600/50"
                    : "bg-white/80 border-green-200/50"
                }`}
              ...
              {showUserMenu && (
                <div
                  className={`absolute right-0 mt-4 w-64 border rounded-2xl shadow-2xl z-50 backdrop-blur-xl ${
                    isDarkMode
                      ? "bg-gray-800/95 border-gray-600/50"
                      : "bg-white/95 border-green-200/50"
                  }`}
