...
function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className={`hidden lg:flex lg:flex-col lg:w-72 lg:fixed lg:inset-y-0 backdrop-blur-xl border-r shadow-2xl ${
        isDarkMode 
        ...
        <div className="flex flex-col flex-1 min-h-0">
          {/* Logo */}
          <div className={`flex items-center h-20 px-8 border-b bg-gradient-to-r from-[#30BF6E] to-[#8CBF3F] shadow-lg ${
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white drop-shadow-md">EcoCommerce</h1>
                <p className="text-xs text-green-100 font-medium">Transformando el futuro</p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className={`flex items-center justify-between h-20 px-6 border-b bg-gradient-to-r from-[#30BF6E] to-[#8CBF3F] ${
            isDarkMode ? 'border-gray-700/50' : 'border-green-200/30'
          }`}>
            <div className="flex items-center space-x-3">
              <Leaf className="w-8 h-8 text-white drop-shadow-lg" />
              <div>
                <h1 className="text-xl font-bold text-white drop-shadow-md">EcoCommerce</h1>
                <p className="text-xs text-green-100">Transformando el futuro</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
