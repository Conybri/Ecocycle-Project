...
function DashboardPage() {
  ...
  const userStats = [
    {
      ...
      color: "from-[#1F82BF] to-[#30BF6E]",
      bgColor: "from-blue-500/10 to-green-500/10",
      description: "recolecciones programadas",
    },
    {
      title: "EcoPoints",
      value: "1,250",
    ...
    {
      title: "Empresas Recolectoras Favoritas",
      value: "3",
      change: "+1 nueva",
      changeType: "positive",
      icon: Heart,
      color: "from-[#30BF6E] to-[#8CBF3F]",
      bgColor: "from-green-500/10 to-lime-500/10",
      description: "empresas guardadas",
    },
    {
      title: "CO₂ Evitado",
      value: "2.5kg",
      ...
      description: "gracias a tus recolecciones",
    },
    {
      ...
      color: "from-[#1F82BF] to-[#30BF6E]",
      bgColor: "from-blue-500/10 to-green-500/10",
      description: "recolectados este mes",
    },
    {
      title: "Eventos de Recolección",
      value: "10",
      change: "agendadas",
      changeType: "positive",
      icon: Calendar,
      color: "from-[#F2A341] to-[#F28241]",
      bgColor: "from-orange-400/10 to-orange-500/10",
      description: "recolecciones agendadas",
    },
  ];
      ...
      : [
          {
            ...
            title: "Plástico PET",
            description:
              "Estado: Pendiente • Empresa: EcoRecoge S.A. • EcoPoints: +50",
            time: "Fecha: 2025-08-19",
            type: "material",
            color: "green",
            icon: Recycle,
            value: "50 EcoPoints",
          },
          {
            ...
            description:
              "Estado: Programada para el 25/08 • Empresa: ReciclaYa • EcoPoints: +25",
            time: "Fecha: 2025-08-14",
            type: "material",
            color: "blue",
            icon: Recycle,
            value: "25 EcoPoints",
          },
          {
            ...
            title: "Vidrio",
            description:
              "Estado: Recolectado • Empresa: VidrioLimpio • EcoPoints: +100",
            time: "Fecha: 2025-08-07",
            type: "material",
            color: "purple",
            icon: Recycle,
            value: "100 EcoPoints",
          },
          {
            ...
            title: "Aluminio",
            description:
              "Estado: Pendiente • Empresa: MetalRecicla • EcoPoints: +75",
            time: "Fecha: 2025-08-01",
            type: "material",
            color: "orange",
            icon: Recycle,
            value: "75 EcoPoints",
  ...
  const popularProducts = [
    {
      id: 1,
      name: "Actualizaciones de nivel Eco",
      image:
        "https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=400&h=300&fit=crop",
      description: "¡Has alcanzado el nivel Plata!",
      trending: true,
    },
    {
      id: 2,
      name: "Nuevas empresas recolectoras",
      image:
        "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400&h=300&fit=crop",
      description: "¡Recolectores S.A. se ha unido a nuestra red!",
      trending: false,
    },
    {
      id: 3,
      name: "Nuevos tipos de materiales aceptados",
      image:
        "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=400&h=300&fit=crop",
      description: "Ahora aceptamos metales.",
      trending: true,
    },
    {
      id: 4,
      name: "Eventos de reciclaje locales",
      image:
        "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=400&h=300&fit=crop",
      description: "Gran jornada de limpieza en el Parque Central.",
      trending: false,
    },
    {
      id: 5,
      name: "Tips de sostenibilidad",
      image:
        "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=400&h=300&fit=crop",
      description: "Reduce tu huella de carbono con estos sencillos pasos.",
      trending: true,
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="flex items-center space-x-2 bg-white text-[#30BF6E] hover:bg-gray-100 px-4 py-3 rounded-2xl font-semibold transition-all duration-300 hover:scale-105">
                ...
                <span>Solicitar una Recolección</span>
              </button>
              <button className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 px-4 py-3 rounded-2xl font-semibold transition-all duration-300 hover:scale-105">
                ...
                <span>Encontrar Punto de Recolección</span>
              </button>
              <button className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 px-4 py-3 rounded-2xl font-semibold transition-all duration-300 hover:scale-105">
                <Eye className="w-4 h-4" />
                <span>Explorar Empresas Recolectoras</span>
              </button>
              <button className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 px-4 py-3 rounded-2xl font-semibold transition-all duration-300 hover:scale-105">
                <Eye className="w-4 h-4" />
                <span>Ver Mi Impacto Detallado</span>
              </button>
            </div>
          </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <p className="text-2xl font-bold text-gray-800 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors duration-300 mb-1">
                  {stat.value}
                </p>
      ...
      <div className="bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-600 rounded-3xl p-8 border border-green-200/50 dark:border-gray-600/50 shadow-lg">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Juntos estamos transformando el futuro del planeta
          </p>
        </div>
          ...
          {ecoImpactData.map((item, index) => {
            ...
            return (
              <div key={index} className="group text-center">
                <div
                  className={`relative w-20 h-20 mx-auto mb-4 bg-gradient-to-br ${item.bgColor} dark:bg-gradient-to-br dark:from-gray-700/50 dark:to-gray-600/50 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 cursor-pointer`}
                >
          ...
          <div className="space-y-4 max-h-80 overflow-y-auto">
            {recentActivities.map((activity) => {
              ...
              return (
                <div
                  key={activity.id}
                  className={`flex items-center space-x-4 p-4 bg-gradient-to-r ${getActivityColor(
                    activity.color
                  )} dark:bg-gradient-to-r dark:from-gray-700/50 dark:to-gray-600/50 rounded-2xl hover:shadow-md transition-all duration-200 cursor-pointer group border dark:border-gray-600/50`}
                >
                  <div
                    className={`w-10 h-10 bg-gradient-to-br from-${activity.color}-500 to-${activity.color}-600 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-200`}
                  >
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-6 border border-white/50 dark:border-gray-700/50 shadow-lg">
          ...
          <div className="space-y-4">
            {popularProducts.map((product) => (
              <div
                key={product.id}
                className="flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:bg-gradient-to-r dark:from-gray-700/50 dark:to-gray-600/50 rounded-2xl hover:shadow-md transition-all duration-200 group cursor-pointer border border-green-100 dark:border-gray-600/50"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {product.inStock ? (
                      ...
                      <span className="text-xs bg-green-100 text-red-700 px-2 py-1 rounded-full font-medium">
                        Disponible
                      </span>
                    )}
                  </div>
        ...
        <div className="bg-gradient-to-br from-[#30BF6E] via-[#8CBF3F] to-[#F2A341] rounded-3xl p-8 text-white text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg opacity-90 mb-6">
              Tienes 1,250 EcoPoints listos para usar en productos sostenibles
            </p>
