...
const materials = [
  {
    ...
    category: "Plástico",
    image:
      "https://www.paiscircular.cl/wp-content/uploads/2019/06/shutterstock_PET.jpg",
  ...
  },
  {
    ...
    image:
      "https://natura-activa.com/wp-content/uploads/2021/06/peligro-de-la-basura-electronica.jpg",
  ...
  },
  {
    ...
    category: "Textiles",
    image:
      "https://www.residuosprofesional.com/wp-content/uploads/2023/05/Textiles-euric.jpg",
  ...
  },
  {
    ...
    category: "Vidrio",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmPCBgSg6KvN0OjFlTgxrOXcMp5z3XDL1EMdPxS_nUNKUOcoJzxYE6mY8alC6n12DcqQg&usqp=CAU",
  ...
  },
  {
    ...
    category: "Papel",
    image:
      "https://www.reciclaplanetalimpio.cl/wp-content/uploads/2019/06/papel.jpg",
  ...
  },
  {
    ...
    category: "Metal",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLipkGA67nrhQh99hBCTSLlMoF89PquJUSiQ&s",
...
export default function Catalogo() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white min-h-screen pt-40">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explora los materiales que puedes reciclar, gana puntos y ayuda al
            planeta.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {filteredMaterials.map((material) => (
            <div
              key={material.id}
              className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-gray-200 flex flex-col"
            >
              {/* Image */}
              <img
                src={material.image}
