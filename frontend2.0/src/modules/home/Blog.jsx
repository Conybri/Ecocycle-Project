  ...
  const chileanArticles = [
    {
      ...
      description:
        "El documento oficial que marca la estrategia del país. Es fundamental.",
    ...
    },
    {
      ...
      description:
        "El portal oficial sobre la Ley de Responsabilidad Extendida del Productor, un pilar de la economía circular en Chile.",
      url: "https://leyrep.cl/",
    ...
    },
    {
      ...
      description:
        "Plataforma que promueve la economía circular y conecta a distintos actores en Chile.",
    ...
    },
    {
      ...
      source: "Eurochile",
      description:
        "Artículos y noticias sobre la implementación de la economía circular en Chile con una perspectiva de colaboración con Europa.",
  ...
  const internationalBlogs = [
    {
      ...
      description:
        "La organización líder mundial en economía circular. Su sitio en español es una mina de información.",
    ...
    },
    {
      ...
      source: "España",
      description:
        "Un referente ibérico con análisis de normativas y proyectos.",
    ...
    },
    {
      ...
      source: "Blog Popular",
      description:
        "Un blog muy popular con consejos prácticos para un estilo de vida más sostenible.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Artículos y sitios relevantes sobre economía circular y
            sostenibilidad.
          </p>
        </div>
        ...
        <div className="space-y-12">
          <section className="bg-white rounded-xl p-6 md:p-8 shadow-md">
            <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-8 pb-4 border-b-2 border-green-500">
              Artículos y Sitios Relevantes de Chile
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {chileanArticles.map((article) => (
                <div
                  key={article.id}
                  className="border border-gray-200 rounded-lg p-6 bg-white hover:shadow-xl hover:-translate-y-1 transition-transform flex flex-col"
                >
          ...
          <section className="bg-white rounded-xl p-6 md:p-8 shadow-md">
            <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-8 pb-4 border-b-2 border-green-500">
              Blogs y Referentes Internacionales
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="mb-10">
            <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-xl p-10 text-center">
              <h2 className="text-2xl font-bold mb-2">Mantente Informado</h2>
              <p className="mb-6 opacity-90">
                Suscríbete para recibir las últimas noticias sobre economía
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-grow p-3 rounded-md  bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-white"
                />
                <button className="px-6 py-3 bg-white text-green-600 font-bold rounded-md hover:bg-gray-200 transition-colors">
                  Suscribirse
                </button>
              </div>
            </section>
