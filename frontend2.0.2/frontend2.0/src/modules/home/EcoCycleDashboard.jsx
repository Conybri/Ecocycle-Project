              ...
              <a
                ...
                className={`sidebar-item flex items-center px-4 py-3 rounded-lg ${
                  activeSection === "dashboard"
                    ? "text-eco-blue bg-blue-50 font-medium"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-100 rounded-lg hover:bg-gray-50">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block px-2 py-1 text-xs bg-eco-green text-white rounded-full">
                      Entregado
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-100 rounded-lg hover:bg-gray-50">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block px-2 py-1 text-xs bg-eco-orange text-white rounded-full">
                      En Tránsito
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-100 rounded-lg hover:bg-gray-50">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block px-2 py-1 text-xs bg-eco-blue text-white rounded-full">
                      Procesando
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                  <img
                    src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/6669664d-191b-467f-a24b-bf8ea3edb0b7.png"
                    alt="Botella de agua reutilizable de acero inoxidable con diseño ecológico moderno"
                ...
                <div className="flex items-center space-x-4 p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                  <img
                    src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/10984de1-e355-4236-9b9d-7123f51c9d96.png"
                    alt="Set de bolsas reutilizables de algodón orgánico para compras sostenibles"
                    className="w-12 h-12 rounded-lg object-cover"
                  />
                  <div className="flex-1">
                    <div className="font-medium text-gray-800">
                ...
                <div className="flex items-center space-x-4 p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
                  <img
                    src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/fe4d267a-7a43-4e28-991c-a4af4d74a690.png"
                    alt="Panel solar portátil compacto para cargar dispositivos móviles de manera sostenible"
                    className="w-12 h-12 rounded-lg object-cover"
                  />
                  <div className="flex-1">
                    <div className="font-medium text-gray-800">
            ...
            <div className="space-y-4">
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  Sección de órdenes en desarrollo
                </p>
              </div>
            </div>
          </div>
