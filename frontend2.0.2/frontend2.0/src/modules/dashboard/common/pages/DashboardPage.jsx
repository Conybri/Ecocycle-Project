...
const { isDarkMode } = useTheme()
  ...
  const recentActivities = user?.role === "ADMIN" ? [
  ...
  ] : [
    {
      id: 1,
      title: "Plástico PET",
      description: "Estado: Pendiente • Empresa: EcoRecoge S.A. • EcoPoints: +50",
    ...
    },
    {
      ...
      description: "Estado: Programada para el 25/08 • Empresa: ReciclaYa • EcoPoints: +25",
    ...
    },
    {
      id: 3,
      title: "Vidrio",
      description: "Estado: Recolectado • Empresa: VidrioLimpio • EcoPoints: +100",
    ...
    },
    {
      id: 4,
      title: "Aluminio",
      description: "Estado: Pendiente • Empresa: MetalRecicla • EcoPoints: +75",
