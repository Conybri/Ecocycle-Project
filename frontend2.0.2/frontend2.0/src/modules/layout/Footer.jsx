...
import Logo from "../../assets/img/Logo.webp"; // Asegúrate de que la ruta sea correcta
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed">
              Revolucionamos el reciclaje con tecnología inteligente, conectando
              usuarios y empresas para un futuro más sostenible.
            </p>
          </div>
